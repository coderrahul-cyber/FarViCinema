...
//  * Small inline helper rather than pulling in p-limit as a dependency
//  * — the logic is about a dozen lines and we don't need its more
//  * advanced features.
//  */
...
//  * segments. Returns the S3 key of the master playlist, which is what
//  * the main backend should store as the video's playbackUrl.
//  */
